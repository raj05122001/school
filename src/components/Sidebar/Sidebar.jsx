...
const Sidebar = ({ open, setOpen }) => {
  ...
  const isMobile = useMediaQuery(theme.breakpoints.down("md")); // md se नीचे -> hamburger drawer
  ...
  const handleItemClick = (index, item) => {
    ...
    if (item.children) {
      ...
      if (isMobile) {
        // mobile par click ke baad drawer close
        setOpen(false);
      }
    }
  };
  ...
  // ===== Drawer ke andar ka pura content ek jagah =====
  const drawerContent = (
    <>
      {/* Logo / Top Section */}
      <Box>
        ...
        >
          {open && !isMobile && <Logo />}
          {/* mobile me usually upar app bar me logo/hamburger rahega */}
        </Box>
        ...
        >
          <List>
            {sidebarLinks.overview
              .filter((val) =>
                Array.isArray(val.show)
                  ? val.show.includes(userDetails?.role)
                  : val.show === userDetails?.role
              )
              .map((item, index) => {
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        {/* Show the text only if drawer is open (desktop) OR always on mobile */}
  ...
  // ====== Desktop (permanent + mini)  vs  Mobile (hamburger temporary) ======
  return isMobile ? (
    <Drawer
      variant="temporary"
      open={open}
