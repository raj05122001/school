...
import StudentLiteratureMindMap from "@/components/mind_maps/StudentLiteratureMindMap";
...
const LecturePage = ({ params }) => {
  ...
  return (
    ...
    >
     ...
     {Number(id)===805 && <StudentMindMaps lectureId={id}/>}
      {Number(id)===805 &&<StudentLiteratureMindMap lectureId={id}/>}
    </Box>
  );
};
